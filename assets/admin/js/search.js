...
function filterSettings(query) {
    ...
    for (var key in settingsData) {
        if (settingsData.hasOwnProperty(key)) {
            ...
            // Check if the setting has submenu
            if (setting.submenu) {
                setting.submenu.forEach(subItem => {
                    // Only include if the user has permission
                    if (userRolePermissions === true || userRolePermissions?.includes(subItem.route_name)) {
                ...
                // Only include if the user has permission
                if (userRolePermissions === true || userRolePermissions?.includes(setting.route_name)) {
                    ...
                    var subtitleMatch = setting.subtitle ? setting.subtitle.toLowerCase().includes(query.toLowerCase()) : false;
