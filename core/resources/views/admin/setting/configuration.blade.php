            ...
            <div class="card">
                <form method="post">
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            <li
                                class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center px-3">
                                <div>
                            ...
                            <li
                                ...
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        data-offstyle="-danger" data-bs-toggle="toggle" data-height="35"
                                        data-on="@lang('Enable')" data-off="@lang('Disable')" name="post_approval"
                                        @checked(gs('post_approval'))>
                                </div>
                            </li>
                    ...
                    @can('admin.setting.system.configuration.update')
