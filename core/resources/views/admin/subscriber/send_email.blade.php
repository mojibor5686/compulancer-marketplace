                    ...
                    <div class="row gy-4 justify-content-center">
                        <div class="col-sm-6">
                            <x-widget link="javascript:void(0)" style="6" icon="fas fa-list" title="Email should be sent"
                                value="{{ isset($sessionData['total_subscriber']) ? $sessionData['total_subscriber'] : 0 }}" bg="primary" :viewMoreIcon=false />
                        </div>
                        <div class="col-sm-6">
                            <x-widget link="javascript:void(0)" style="6" icon="fa-solid fa-envelope-circle-check" title="Email has been sent"
                                value="{{ isset($sessionData['total_sent']) ? $sessionData['total_sent'] : 0 }}" bg="success" :viewMoreIcon=false />
                        </div>
                        <div class="col-sm-6">
                            <x-widget link="javascript:void(0)" style="6" icon="fa-solid fa-paper-plane" title="Email has yet to be sent"
                                :viewMoreIcon=false value="{{ (isset($sessionData['total_subscriber']) ? $sessionData['total_subscriber'] : 0) - (isset($sessionData['total_sent']) ? $sessionData['total_sent'] : 0) }}" bg="warning" />
                        </div>
                        <div class="col-sm-6">
                            <x-widget link="javascript:void(0)" style="6" icon="fas fa-envelope" title="Email per batch"
                                value="{{ isset($sessionData['batch']) ? $sessionData['batch'] : 0 }}" bg="primary" :viewMoreIcon=false />
                        </div>
                        <div class="col-12">
                            <div class="card">
                                    ...
                                    <div class="coaling-loader flex-column d-flex justify-content-center">
                                        <div class="countdown">
                                            <div class="coaling-time">
                                                <span class="coaling-time-count">{{ isset($sessionData['cooling_time']) ? $sessionData['cooling_time'] : 0 }}</span>
                                            </div>
                                            <div class="svg-count">
                                        ...
                                        <p class="text--primary">
                                            @lang(' ' . (isset($sessionData['total_sent']) ? $sessionData['total_sent'] : 0) . ' out of ' . (isset($sessionData['total_subscriber']) ? $sessionData['total_subscriber'] : 0) . 'email were successfully transmitted')
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 start-from-col">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="start" value="{{ old('start', isset($sessionData['start']) ? $sessionData['start'] : '') }}" type="number"
                                    ...
                                    <div class="col-md-4 cooling-period-col">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" name="cooling_time" value="{{ old('cooling_time', isset($sessionData['batch']) ? $sessionData['batch'] : '') }}"
