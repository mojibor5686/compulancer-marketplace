            ...
            <div class="card overflow-hidden box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        @if (@$deposit->order_number)
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                @lang('Order Number')
                                <span class="fw-bold">
                                    @if (@$deposit->booking->service)
                                        <a target="_blank"
                                            href="{{ route('admin.service.details', @$deposit->booking->service_id) }}">{{ @$deposit->order_number }}</a>
                                    @elseif(@$deposit->booking->software)
                                        <a target="_blank"
                                            href="{{ route('admin.software.details', @$deposit->booking->software_id) }}">{{ @$deposit->order_number }}</a>
                                    @else
                ...
                <div class="card overflow-hidden box--shadow1">
                    <div class="card-body">
                        ...
                        @if ($details != null)
                            ...
                            @endif
                        @endif
                        @canAny('admin.deposit.reject', 'admin.deposit.approve')
