<ul class="nav nav-tabs mb-4 topTap breadcrumb-nav" role="tablist">
    ...
    @canAny('admin.gateway.automatic.index', 'admin.gateway.automatic.edit'])
        <li class="nav-item {{ menuActive(['admin.gateway.automatic.index', 'admin.gateway.automatic.edit') }}"
            role="presentation">
    ...
    @canAny('admin.gateway.manual.index', 'admin.gateway.manual.edit', 'admin.gateway.manual.create')
        <li class="nav-item {{ menuActive(['admin.gateway.manual.index', 'admin.gateway.manual.edit', 'admin.gateway.manual.create']) }}"
            role="presentation">
