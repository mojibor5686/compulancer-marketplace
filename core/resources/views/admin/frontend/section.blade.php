                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <x-image-uploader class="w-100" name="image_input[{{ $imgKey }}]"
                                                        :imagePath="frontendImage(
                                                            $key,
                                                            isset($content->data_values->$imgKey)
                                                                ? $content->data_values->$imgKey
                                                                : '',
                                                            isset($section->content->images->$imgKey->size)
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control iconPicker icon"
                                                                ...
                                                                value="{{ isset($content->data_values->$k) ? $content->data_values->$k : '' }}"
                                                                required>
                                                        ...
                                                        <select class="form-control select2"
                                                            ...
                                                            @foreach ($item->options as $selectItemKey => $selectOption)
                                                                <option value="{{ $selectItemKey }}"
                                                                    @if ((isset($content->data_values->$selectName) ? $content->data_values->$selectName : '') == $selectItemKey) selected @endif>
                                                                    {{ $selectOption }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                    ...
                                    <tr>
                                        ...
                                        @foreach ($section->element as $k => $type)
                                            @if ($k != 'modal' && $k != 'seo')
                                                ...
                                                @elseif($k == 'select')
                                                    <th>{{ keyToTitle(isset($section->element->$k->name) ? $section->element->$k->name : '') }}
                                                    </th>
                                                @endif
                                            @endif
                                        @endforeach
                                        ...
                                        <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="user d-flex">
                                                        <div class="thumb me-2">
                                                            <img src="{{ frontendImage($key, isset($data->data_values->$firstKey) ? $data->data_values->$firstKey : '', isset($section->element->images->$firstKey->size) ? $section->element->images->$firstKey->size : null) }}"
                                                                alt="image">
                                                        </div>
                                                    </div>
                                            ...
                                            @foreach ($section->element as $k => $type)
                                                @if ($k != 'modal' && $k != 'seo')
                                                    @if ($type == 'text' || $type == 'icon')
                                                        ...
                                                        @else
                                                            <td>{{ isset($data->data_values->$k) ? __($data->data_values->$k) : '' }}
                                                            </td>
                                                        @endif
                                                    @elseif($k == 'select')
                                                        @php
                                                            $dataVal = isset($section->element->$k->name)
                                                                ? $section->element->$k->name
                                                                : '';
                                                        @endphp
                                                        <td>{{ isset($data->data_values->$dataVal) ? $data->data_values->$dataVal : '' }}
                                                        </td>
                                                    @endif
                                                @endif
                                            @endforeach
                                            <td>
                                                <div class="button--group">
                                                    @can('admin.frontend.sections.element.seo')
                                                    ...
                                                    @if ($section->element->modal)
                                                            ...
                                                            if (isset($section->element->images)) {
                                                                foreach (
                                                                    ...
                                                                    $images[] = frontendImage(
                                                                        $key,
                                                                        isset($data->data_values->$imgKey)
                                                                            ? $data->data_values->$imgKey
                                                                            : '',
                                                                        isset($section->element->images->$imgKey->size)
                                                        ...
                                                        <button class="btn btn-sm btn-outline--primary updateBtn"
                                                            ...
                                                            @if (isset($section->element->images)) data-images="{{ json_encode($images) }}" @endif>
                                    ...
                                    @elseif($k == 'select')
                                        <div class="form-group">
                                            ...
                                            <select class="form-control"
                                                name="{{ isset($section->element->$k->name) ? $section->element->$k->name : '' }}">
                                        ...
                                        @foreach ($type as $imgKey => $image)
                                            ...
                                            <div class="form-group">
                                                ...
                                                <x-image-uploader class="w-100" name="image_input[{{ $imgKey }}]"
                                                    ...
                                                    :size="isset($section->element->images->$imgKey->size)
                                                        ? $section->element->images->$imgKey->size
                                                        : null" />
                                            </div>
                                        @endforeach
                                        ...
                                        @foreach ($type as $imgKey => $image)
                                            ...
                                            <div class="form-group">
                                                ...
                                                <x-image-uploader class="w-100" :imagePath="getImage('', $section->element->images->$imgKey->size)"
                                                    ...
                                                    id="updateImage{{ $loop->index }}" :size="isset($section->element->images->$imgKey->size)
                                                        ? $section->element->images->$imgKey->size
                                                        : null"
                                                    :required="false" />
