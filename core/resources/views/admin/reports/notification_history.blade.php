                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline--primary notifyDetail"
                                                ...
                                                @if ($log->notification_type == 'email') @can('admin.report.email.details') data-message="{{ route('admin.report.email.details', $log->id) }}" @else data-message="" @endcan @else data-message="{{ $log->message }}" @if ($log->image) data-image="{{ asset(getFilePath('push') . '/' . $log->image) }}" @endif
