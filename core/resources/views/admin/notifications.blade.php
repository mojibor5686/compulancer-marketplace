            ...
            <div class="notify-item-wrapper">
                ...
                @can('admin.notifications.delete.single')
                    <button type="button" class="btn btn-sm btn-outline--danger notify-delete-btn confirmationBtn"
                        ...
                        data-action="{{ route('admin.notifications.delete.single', $notification->id) }}"><i
...
@push('breadcrumb-plugins')
    @can('admin.notifications.read.all')
        @if ($hasUnread)
            <a href="{{ route('admin.notifications.read.all') }}" class="btn btn-sm btn-outline--primary"><i
    ...
    @can('admin.notifications.delete.all')
        @if ($hasNotification)
            <button class="btn btn-sm btn-outline--danger confirmationBtn"
                data-action="{{ route('admin.notifications.delete.all') }}" data-question="@lang('Are you sure to delete all notifications?')"><i
