...
@else
    ...
    <head>
        ...
        <title>{{ gs()->siteName($pageTitle ?? '423 | Locked') }}</title>
            ...
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-7 text-center">
                        ...
                        <h2 class="title">@lang('Sorry! This file is currently locked.')</h2>
                        <p class="description">@lang('Please go back, refresh your browser and try again')</p>
