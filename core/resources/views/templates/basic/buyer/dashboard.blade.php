...
@section('content')
    ...
    <div class="dashboard-widget-grid">
        ...
        <div class="widget-dashboard widget-gradient widget-balance">
            ...
            <a class="widget-dashboard__arrow" href="{{ route('user.transactions') }}">
        ...
        <div class="widget-dashboard">
            <a href="{{ route('user.buyer.job.index') }}" class="widget-link"></a>
            ...
            <div class="widget-dashboard__content">
                <div class="widget-dashboard__wrapper">
                    <span class="widget-dashboard__label">@lang('Total Job')</span>
                    <h4 class="widget-dashboard__total">{{ $totalJobCount }}</h4>
                </div>
                <a class="widget-dashboard__arrow" href="{{ route('user.buyer.job.index') }}">
                    @include('Template::partials.icons.dashboard.total_service')
                </a>
            </div>
        </div>

        <!-- Total Service Booked Widget -->
        <div class="widget-dashboard">
            <a href="{{ route('user.buyer.booked.services') }}" class="widget-link"></a>
            <div class="widget-dashboard__icon">
                <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M3.5 20C3.08334 20 2.72916 19.8541 2.4375 19.5625C2.14584 19.2709 2 18.9166 2 18.5V13.775H7.1V14.175C7.1 14.3917 7.17085 14.5708 7.3125 14.7125C7.45415 14.8541 7.63335 14.925 7.85 14.925C8.06665 14.925 8.24585 14.8541 8.3875 14.7125C8.52915 14.5708 8.6 14.3917 8.6 14.175V13.775H15.4V14.175C15.4 14.3917 15.4709 14.5708 15.6125 14.7125C15.7542 14.8541 15.9333 14.925 16.15 14.925C16.3666 14.925 16.5458 14.8541 16.6875 14.7125C16.8292 14.5708 16.9 14.3917 16.9 14.175V13.775H22V18.5C22 18.9166 21.8541 19.2709 21.5625 19.5625C21.2709 19.8541 20.9166 20 20.5 20H3.5ZM2.275 12.275L4.6 6.625C4.75 6.375 4.95 6.17085 5.2 6.0125C5.45 5.85415 5.71665 5.775 6 5.775H7.6V4.5C7.6 4.08334 7.74585 3.72916 8.0375 3.4375C8.32915 3.14584 8.68335 3 9.1 3H14.875C15.2916 3 15.6459 3.14584 15.9375 3.4375C16.2291 3.72916 16.375 4.08334 16.375 4.5V5.775H17.975C18.2584 5.775 18.525 5.85415 18.775 6.0125C19.025 6.17085 19.225 6.375 19.375 6.625L21.725 12.275H16.9V11.875C16.9 11.6584 16.8292 11.4791 16.6875 11.3375C16.5458 11.1958 16.3666 11.125 16.15 11.125C15.9333 11.125 15.7542 11.1958 15.6125 11.3375C15.4709 11.4791 15.4 11.6584 15.4 11.875V12.275H8.6V11.875C8.6 11.6584 8.52915 11.4791 8.3875 11.3375C8.24585 11.1958 8.06665 11.125 7.85 11.125C7.63335 11.125 7.45415 11.1958 7.3125 11.3375C7.17085 11.4791 7.1 11.6584 7.1 11.875V12.275H2.275ZM9.1 5.775H14.875V4.5H9.1V5.775Z"
            ...
            <div class="widget-dashboard__content">
                <div class="widget-dashboard__wrapper">
                    <span class="widget-dashboard__label">@lang('Total Service Booked')</span>
                    <h4 class="widget-dashboard__total">{{ $totalBookedService }}</h4>
                </div>
                <a class="widget-dashboard__arrow" href="{{ route('user.buyer.booked.services') }}">
                    @include('Template::partials.icons.dashboard.total_software')
                </a>
            </div>
        </div>

        <!-- Total Purchase Software Widget -->
        <div class="widget-dashboard">
            <a href="{{ route('user.buyer.software.log') }}" class="widget-link"></a>
            <div class="widget-dashboard__icon">
                <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <div class="widget-dashboard__content">
                <div class="widget-dashboard__wrapper">
                    <span class="widget-dashboard__label">@lang('Total Purchase Software')</span>
                    <h4 class="widget-dashboard__total">{{ $totalPurchasedSoftware }}</h4>
                </div>
                <a class="widget-dashboard__arrow" href="{{ route('user.buyer.software.log') }}">
                    @include('Template::partials.icons.dashboard.total_service_booking')
                </a>
            </div>
        </div>

        <!-- Total Hire Employees Widget -->
        <div class="widget-dashboard">
            <a href="{{ route('user.buyer.hiring.list') }}" class="widget-link"></a>
            <div class="widget-dashboard__icon">
                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="30" x="0" y="0" viewBox="0 0 32 32" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g><path d="M6 17c-2.206 0-4-1.794-4-4s1.794-4 4-4 4 1.794 4 4-1.794 4-4 4zm1.77.67c-1.14.44-2.4.44-3.54 0-.29-.11-.62-.07-.88.09A4.995 4.995 0 0 0 1 22v4c0 .55.45 1 1 1h5v-5c0-1.55.41-3.06 1.15-4.38-.13-.02-.26 0-.38.05zM26 17c2.206 0 4-1.794 4-4s-1.794-4-4-4-4 1.794-4 4 1.794 4 4 4zm2.65.76c-.26-.16-.59-.2-.88-.09-1.14.44-2.4.44-3.54 0a.703.703 0 0 0-.38-.05A8.978 8.978 0 0 1 25 22v5h5c.55 0 1-.45 1-1v-4c0-1.73-.88-3.31-2.35-4.24zM16 15c-2.757 0-5-2.243-5-5s2.243-5 5-5 5 2.243 5 5-2.243 5-5 5zm7 7a6.98 6.98 0 0 0-2.87-5.64c-.3-.22-.7-.25-1.03-.09-.67.34-1.38.55-2.1.65V22c0 .55-.45 1-1 1s-1-.45-1-1v-5.08c-.72-.1-1.43-.31-2.1-.65-.33-.16-.73-.13-1.03.09A6.98 6.98 0 0 0 9 22v5h14z" fill="hsl(var(--base))" opacity="1" data-original="hsl(var(--base))" class=""></path></g></svg>
            </div>
            <div class="widget-dashboard__content">
                <div class="widget-dashboard__wrapper">
                    <span class="widget-dashboard__label">@lang('Total Hire Employees')</span>
                    <h4 class="widget-dashboard__total">{{ $totalHiredEmployee }}</h4>
                </div>
                <a class="widget-dashboard__arrow" href="{{ route('user.buyer.hiring.list') }}">
                        ...
                        @foreach (@$reviews ?? [] as $review)
                            <li class="cs-reviews-list-item">
                                ...
                                <div class="cs-reviews-list-item__content">
                                    ...
                                    <p class="cs-reviews-list-item__desc">{{ __($review->review) }}</p>
                                </div>
                            </li>
                        @endforeach
                    </ul>
            ...
            <div class="widget-compact__header">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                    ...
                    <div id="transactionDatePicker" class="border p-1 cursor-pointer rounded d-flex align-items-center">
                        ...
                        <span>November 1, 2024 - November 7, 2024</span>
    ...
    <script>
        (function($) {
            ...
            function updateTransactionChart(startDate, endDate) {
                ...
                const url = '{{ route('user.seller.transactions.chartData') }}';
