        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <form action="{{ route('user.deposit.insert') }}" method="post" class="deposit-form">
                    ...
                    <div class="gateway-card p-0">
                        <div class="row justify-content-center gy-sm-4 gy-3">
                            <div class="col-12">
                                <h5 class="payment-card-title">@lang('Confirm  Deposit')</h5>
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="payment-system-list p-3">
                                    ...
                                    <div class="deposit-info gateway-conversion d-none total-amount pt-2 mb-3">
                                        <div class="deposit-info__title">
                                    ...
                                    <div class="deposit-info conversion-currency d-none total-amount pt-2 mb-3">
                                        <div class="deposit-info__title">
                                            <p class="text">
                                    ...
                                    <button type="submit" class="btn btn--base btn--lg h-45 w-100 mt-3 mb-3" disabled>
