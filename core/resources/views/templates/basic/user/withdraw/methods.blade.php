                        ...
                        <div class="col-lg-6">
                            <div class="payment-system-list p-3">
                                <div class="deposit-info mb-3">
                                    ...
                                    <div class="deposit-info__input mt-2">
                                ...
                                <div class="deposit-info total-amount pt-3 pb-3">
                                    <div class="deposit-info__title">
                                ...
                                <div class="deposit-info gateway-conversion d-none total-amount pt-3 mb-3">
                                    <div class="deposit-info__title">
                                ...
                                <div class="deposit-info conversion-currency d-none total-amount pt-3 mb-3">
                                    <div class="deposit-info__title">
                                        <p class="text">
                                ...
                                <button type="submit" class="btn btn--base w-100 btn--lg mt-3 mb-3" disabled>
                                    @lang('Confirm Withdraw')
                                </button>

                                <div class="info-text pt-3">
                                    <p class="text">@lang('Safely withdraw your funds using our highly secure process and various withdrawal methods')</p>
                                </div>
                            </div>
