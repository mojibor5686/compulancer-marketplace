            ...
            <div class="row justify-content-center" style="position: relative;">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 mb-4 position-relative text-center">
                    ...
                    <div class="step-card-wrapper">
                        ...
                        <p class="step-desc">
                            @lang('Explore thousands of professional softwares for every budget.')
                        </p>
                    </div>
                </div>
                                ...
                                <div class="portfolio-card">
                                    <a href="{{ route('software.details', [slug($product->name), $product->id]) }}"
                                        ...
                                        <div class="portfolio-img-box">
                                            <img src="{{ getImage(getFilePath('software') . '/' . $product->image, getFileSize(@$type)) }}"
                    ...
                    <div class="solutions-list mt-4">
                        ...
                        <div class="solution-item d-flex align-items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="item-desc">@lang('Dramatically reduce your expenses with fixed-price freelance softwares for every budget.')</p>
                            </div>
                        </div>
    ...
    <section class="cta-section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <h2 class="cta-title">Start saving with freelance softwares today</h2>
