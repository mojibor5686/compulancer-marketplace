...
trait BookingOrder
{
    protected static function bookingCreate($orderDetails)
    {
        ...
        $booking->buyer_id = auth()->check() ? auth()->id() : ($orderDetails['buyer_id'] ?? null);
        ...
        if (isset($orderDetails['service'])) {
            ...
            if (isset($orderDetails['extraServices']) && (is_array($orderDetails['extraServices']) || $orderDetails['extraServices'] instanceof Collection)) {
